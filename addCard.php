...
if ($authenticated && $adminID !== $userID) {
    redirect("authentication/login.php");
}
$username = $auth->authenticated_user()["username"];
$tokens = $auth->authenticated_user()["token"];
$cs = new CardStorage();
$deck = $cs->findAll();
...
if (count($_POST) > 0) {
    if (validate($_POST, $data, $errors)) {
        ...
        $cs = new CardStorage();
        $cs->add($data);
        $us->IKemonCardNumUpdate($user, $cs);
        redirect("../index.php");
    }
}
    ...
    <main>
        <form action="" method="post" novalidate>
            ...
            <div>
                ...
                <input type="number" name="hp" value="<?= $_POST["hp"] ?? "" ?>">
            ...
            <div>
                ...
                <input type="number" name="attack" value="<?= $_POST["attack"] ?? "" ?>">
            ...
            <div>
                ...
                <input type="number" name="defense" value="<?= $_POST["defense"] ?? "" ?>">
            ...
            <div>
                ...
                <textarea name="description" rows="6" cols="35"><?= $_POST["description"] ?? "" ?></textarea>
            ...
            <div>
                ...
                <input type="url" name="image" value="<?= $_POST["image"] ?? "" ?>">
